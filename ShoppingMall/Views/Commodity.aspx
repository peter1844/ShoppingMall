...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script src="<%= GetVersionUrl("pages/CommodityComponent.js", "js") %>" type="text/javascript"></script>

    <link href="<%= GetVersionUrl("Commons/menu.css", "css") %>" rel="stylesheet" type="text/css"/>
    <link href="<%= GetVersionUrl("Pages/commodity.css", "css") %>" rel="stylesheet" type="text/css"/>
</head>
<body>
    <div id="app">
        <menulist></menulist>
